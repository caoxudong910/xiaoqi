    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.code == 200) {
                ...
                show += '</div>';
                show += '<div id="demo1">';
                show += '<img src="/static/images/22.jpg" alt="" />';
                show += '</div>';
                show += '<div id="mid_img">';
                show += '<img src="/static/images/gu2.png" alt="">';
                show += '<img src="/static/images/gu4.png" alt="">';
                show += '<img src="/static/images/gu5.png" alt="">';
                show += '<img src="/static/images/gu9.png" alt="">';
                show += '<img src="/static/images/gu8.png" alt="">';
                show += '</div>';

                show += '<div id="mid">';
                show += '<div id="mid_top">';
                show += '<input placeholder="请输入要搜索的商品" id="seek" type="text" name="seek">';
                show += '<button id="sub" onclick="seek()">提交</button>';
                show += '<img src="/static/images/b1.jpg">';
                show += '<img src="/static/images/b3.jpg">';
                show += '</div>';
                ...
                $.each(result.data, function (i, obj) {
                    ...
                    show += '<div class="fl"><b>'+obj.type.title+'</b></div>';
                    show += '<div class="fr"><a href="/' + obj.page.page + '">更多</a></div>';
                    show += '</div>';
                    $.each(obj.goods, function (ix, gobj) {
                        show += '<div id="obj">';
                        show += '<img onclick="img('+gobj.id+')" class="img" src="http://127.0.0.1:8000/static/imgs/snacks/' + gobj.img +' ">';
                        show += '<p>名称：' + gobj.title + '</p>';
                        show += '<p>售价：￥' + gobj.market_price + '</p>';
                        show += '<img onclick="cart('+gobj.id+')" id="cart" src="/static/images/cart.png">';
                        show += '</div>';
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.code == 200) {
                    ...
                    show += '<div id="mid1">';
                    show += '<div id="mid_top1">';
                    show += '<input placeholder="请输入要搜索的商品" id="seek1" type="text" name="seek"><button id="sub1" onclick="seek1()">提交</button>';
                    show += '</div>';
                    show += '<div id="mid_mid1">';
                    $.each(result.data, function (i, obj) {
                        show += '<div id="obj1">';
                        show += '<img onclick="img('+obj.id+')" id="o_img1" src="http://127.0.0.1:8000/static/imgs/snacks/' + obj.img + '">';
                        show += '<p>名称：' + obj.title + ' &nbsp&nbsp￥：' + obj.market_price + '元</p>';
                        show += '<p>商家：' + obj.supplier + '</p>';
                        show += '<img onclick="cart('+obj.id+')" id="cart1" src="/static/images/cart.png">';
                        show += '</div>';
